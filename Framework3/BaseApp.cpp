...
void BaseApp::loadConfig(){
	...
	leftKey       = config.getIntegerDef("KeyLeft",  KEY_A);
	rightKey      = config.getIntegerDef("KeyRight", KEY_D);
	upKey         = config.getIntegerDef("KeyUp",    KEY_CTRL);
	downKey       = config.getIntegerDef("KeyDown",  KEY_SHIFT);
	forwardKey    = config.getIntegerDef("KeyForward",  KEY_W);
	backwardKey   = config.getIntegerDef("KeyBackward", KEY_S);
